...
<head>
	...
	<script>
      ...
      var kakaoAppKey = 'f6418f599c05544bb95ff87f97ae4504';
	...
	<script src="/resources/js/fdd.js"></script>
	<script src="/resources/js/request.js"></script>
	<script type="text/javascript" src="/resources/js/holiday.js"></script>
	<link rel="stylesheet" href="/resources/css/contents_v1.css">


	<link rel="stylesheet" href="/resources/plugin/owl-carousel/assets/owl.carousel.min.css"/>
	<link rel="stylesheet" href="/resources/plugin/owl-carousel/assets/owl.theme.default.css"/>
	<script src="/resources/plugin/owl-carousel/owl.carousel.min.js"></script>

	<link rel="stylesheet" href="/resources/css/layout_style.css">
	<link rel="stylesheet" href="/resources/css/a-guide.css">
	<link rel="stylesheet" href="/resources/css/contents2.css">
...
<div class="modal fade show" id="alertModal2" style="z-index: 1051" tabindex="-1" aria-labelledby="alertModalLabel"
        ...
        <div class="cbody-cont">
            <div class="agree-wrap">
				...
				<div class="dropdown site-link" style="padding-block: 20px;
				    ...
				    margin-inline: 10px;">
					<button class="btn dropdown-toggle" type="button" style="width: 230px"
					        data-toggle="dropdown" aria-expanded="false">
						개인정보처리방침 변경이력
					</button>
					<div class="dropdown-menu" style="width: 230px">
						<a class="dropdown-item privacy" data-idx="1"  href="javascript:void(0)"
						>2023-09-21 시행</a>
						<a class="dropdown-item privacy" data-idx="2"  href="javascript:void(0)"
						>2023-08-10 시행</a>
						<a class="dropdown-item privacy" data-idx="3"  href="javascript:void(0)"
						>2023-01-25 시행</a>
						<a class="dropdown-item privacy" data-idx="4" href="javascript:void(0)"
						>2020-03-10 시행</a>
					</div>
				</div>
			</div>
	...
	<div class="agree-wrap">
		...
		<!--e:repeat agree cont-->
				...
				<div class="dropdown site-link" style="padding-block: 20px;
					...
					<div class="dropdown-menu" style="width: 230px">
						<a class="dropdown-item" data-idx="1"  href="javascript:void(0)"
						>2023-01-25 시행</a>
						<a class="dropdown-item" data-idx="2" href="javascript:void(0)"
						>2020-03-10 시행</a>
					</div>
				</div>
			</div>
...
<textarea id="noAvailTpl" style="display: none">
	<li>
		<div class="thumb">
	...
	<div class="modal-dialog basic-width modal-dialog-centered">
		...
		<div class="modal-content">
			<div class="modal-header" style="border:0; padding-bottom:16px;">
				...
				<button style="margin-right:-2px; margin-top:4px;" type="button" class="btn-close" data-dismiss="modal"
				        aria-label="Close">
			...
			<p data-all-ignore
			   style="display: none; text-align: center; font-size:16px; font-weight:500; margin-bottom:20px; color:#333; margin-top:10px;">
