			...
			<div class="section">
				<div class="cbody-cont">
					<div class="tab-wrap inquiry-wrap">
						<!--S:201200110 탭 순서 변경 -->
						<ul class="tab-type02">
							<li class="item is-active"><button onclick="javascript:tabOpen(0);" type="button" data-href="js-tab-cont" data-idx="0" class="tab-link js-tab-link">가맹점 개설 안내</button></li>
							<li class="item"><button onclick="javascript:tabOpen(1);" type="button" data-href="js-tab-cont" data-idx="1" class="tab-link js-tab-link">모닝스텝 안내</button></li>
						</ul>
						<!--S:가맹점개설 안내  >-->
						<div class="tab-cont js-tab-cont js-tab-cont-0">
							...
							<div class="tab-cont js-btab-cont js-btab-cont-3">
								...
								<ul class="business-special">
									<li><i class="ico ico-business-special01"></i>
										...
										<p class="desc">풀무원녹즙은 건강을 생각하는 고객들에게 많은 사랑을 받고 있는 NO.1 녹즙
											브랜드입니다.</p></li>
									<li><i class="ico ico-business-special02"></i>
										<p class="title">손쉬운 창업</p>
										<p class="desc">
											최소한의 비용으로 창업가능!!<br>인수권리금(규모에 따라 차이) 점포임차금 외 가맹비 550만원,
											시설비용 300만원 수준으로 창업이 가능하며, 점포(사업장)의 위치도 이면도로에 있어도 가능하기 때문에 초기
											투자비가 낮습니다. 인수권리금은 회원수에 따라 차이가 있으며, 풀무원녹즙 전산시스템에 등록된 기준으로 투명하게
											정산이 되며, 인수 이후 회원의 증가 시 영업권의 가치를 높일 수 있습니다.
										</p></li>
									<li><i class="ico ico-business-special04"></i>
										<p class="title">믿을 수 있는 제품</p>
										<p class="desc">전국 산지 농가와 유기농업의 장인과 계약 재배를 통해 유기농 원료를 확보하고
											있으며, 풀무원기술연구원에서 한 달에 한 번 유기농산물과 토양을 검사, 분석, 관리하여 안전한 원료만을
											사용합니다. 풀무원녹즙은 세계 최대 생즙공장을 보유하고 있으며, 친환경 생산시설에서 주문된 양만큼만 수확해 세척,
											착즙, 살균, 혼합, 충진, 검사, 배송을 준비하고 하루 29만개, 연간 1억개의 녹즙 생산이 가능합니다.</p></li>
									<li><i class="ico ico-business-special05"></i>
										<p class="title">가맹본부 주도의 광고ㆍ홍보 집행</p>
										<p class="desc">풀무원녹즙에서는 가맹점 사업자의 부담 없이 가맹본부 주도로 광고ㆍ홍보를 실시하고
											있습니다.</p></li>
								</ul>
								...
								<ul class="business-state">
									<li><i class="ico ico-business-state01"></i>
										<p class="desc">풀무원녹즙은 1995년 바른먹거리 풀무원의 건강신선음료 사업으로 시작하여 매일
											아침 신선한 채소와 과일의 영양을 그대로 고객에게 전하고 있습니다.</p></li>
									<li><i class="ico ico-business-state02"></i>
										<p class="desc">전국 약 400여개 가맹점(오피스 가맹점 250여개, 홈 가맹점 150여개)을
											통해 음용을 원하는 고객에게 매일 아침 신선하게 제품을 배송하고 있습니다.</p></li>
									<li><i class="ico ico-business-state03"></i>
										<p class="desc">각 가맹점에서는 신선 배송을 위해 배송스텝을 모집하여 운영하고 있으며,
											오피스(사무실)는 모닝스텝이, 홈(가정)은 홈스텝이라고 부르며 전국 1,500여명의 배송스텝들이 고객들의 배송을
											책임지고 있습니다.</p></li>
								</ul>
							...
							<div class="tab-cont js-btab-cont js-btab-cont-5" style="display: none;">
								...
								<p class="stitle-desc">※ 가맹점 개설확정(선정위원회 심의) 통보 후 20일 내 계약 체결이
									되며 가맹점주 필수 교육 이수 후 사업을 시작할 수 있습니다.</p>
								<!-- s: 개설프로세스 -->
								<div class="stp-process-wrap">
									<ul>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process01"></i></span> <em class="step">STEP
											01</em>
											<p class="title">개설문의</p>
											<p>홈페이지 상담신청</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process02"></i></span> <em class="step">STEP
											02</em>
											<p class="title">사업신청서 접수</p>
											<p>
												개설 상담 후<br>사업신청서 &amp; 자기소개서 접수
											</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process03"></i></span> <em class="step">STEP
											03</em>
											<p class="title">사업후보자 검증심사</p>
											<p>가맹점 선정위원회 심사</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process04"></i></span> <em class="step">STEP
											04</em>
											<p class="title">개설확정 통보</p>
											<p>정보공개서 외 법적 문서 발송</p></li>
									</ul>
									<ul>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process05"></i></span> <em class="step">STEP
											05</em>
											<p class="title">
												사무실확정 및<br>임대차 계약
											</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process06"></i></span> <em class="step">STEP
											06</em>
											<p class="title">사업서류 구비</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process07"></i></span> <em class="step">STEP
											07</em>
											<p class="title">가맹점주 필수 교육 이수</p>
											<p>
												개설 전 본사 정규과정<br>- 온라인(e러닝)<br>- 오프라인(집합)
											</p></li>
										<li><span class="stp-process-step-wrap"><i class="ico ico-stp-process08"></i></span> <em class="step">STEP
											08</em>
								...
								<p class="stitle-desc">
									※ 가맹점 개설은 기존 영업권을 인수하는 형태로 진행이 되며 최소한의 비용으로 개설을 하실 수 있도록 지원하여
									드립니다.<br>가맹점 규모, 영업지역, 고객수에 따라 소요 비용에 차이가 있을 수 있습니다.(임대보증금은
									포함되어 있지 않습니다.)
								</p>
								<!-- s: 개설비용 -->
								<div class="stp-cost">
									<table class="tbl-col">
										...
										<tfoot>
										<tr class="total">
											<th scope="row" style="text-align: center">합계										
											</th><td>최소 2750만원 ~ 1억 9.5만원</td>
											<td></td>
										</tr>
										</tfoot>
									</table>
							...
							<div class="tab-cont js-btab-cont js-btab-cont-6" style="display: none;">
								<div class="qualification-title-wrap">
									<div class="qualification-title">
										...
										<p class="stitle-desc">개설을 희망하는 지역 및 문의사항은 상담 시 상세히 안내해
											드립니다.</p>
									</div>
									<button type="button" class="btn-mid green" onclick="javascript:$('.pop-qualification-area').dialog('open');">개설
										가능 지역 보기</button>
								</div>
								...
								<ul class="qualification-info">
									...
									<li><i class="ico ico-qualification-info02"></i>
										...
										<p class="desc">
											풀무원녹즙 전산시스템을 무료로 제공하여 고객 주문 · 배송 · 결제 · 정산 등을 편리하게 할 수 있도록
											도와드립니다.<br>배송 직원들에게는 모바일 고객관리 시스템을 제공하여 간편하게 고객 관리를 하실 수
											있습니다.<br>철저한 상권 분석으로 성공적인 사업을 지원합니다.<br>※전산기기는 별도 구비
											필요
										</p></li>
									<li><i class="ico ico-qualification-info03"></i>
										...
										<p class="desc">가맹본부에서는 다양한 프로모션을 통해 가맹점의 판매활동을 지원하고 있으며,
											가맹점은 영업지역 내 홍보 활동을 통해 매출을 더욱 올릴 수 있습니다.</p></li>
									...
									<li><i class="ico ico-qualification-info05"></i>
										...
										<p class="desc">배송 스텝 구인이 가능하도록 브랜드 채용 사이트를 무료로 이용할 수 있게
											지원드립니다.</p></li>
								...
								<form id="listForm">
									...
									<table class="tbl-row">
										...
										<tr>
											...
											<td class="input">
												<div class="ip-wrap">
													<input title="입력" id="phone" data-call-text="" name="phone" type="hidden" placeholder="‘-’없이 숫자만 입력해주세요" maxlength="13"> <span class="message" id="phoneError"></span>
												<input title="입력" name="_x_phone" type="text" placeholder="‘-’없이 숫자만 입력해주세요" maxlength="13"></div>
											</td>
										</tr>
										<tr>
											<th scope="row">이메일</th>
											<td class="input">
												<div class="ip-wrap">
													<div class="ip-email-wrap">
														<input type="text" title="이메일 아이디 입력" id="email" name="email" placeholder="이메일" value="">
														<input type="hidden" title="이메일 아이디 입력" id="emailFull" name="emailFull" placeholder="이메일" value="@naver.com">
														<span class="gap">@</span>
														<input type="text" title="이메일 도메인 직접입력" id="emailHost" name="emailHost" value="">
														<select title="이메일 도메인 선택" id="emailHostList" name="emailHostList">
												...
												<div class="agree-container js-fold-container" style="display: none;">
													<div class="agree-cont">
														...
														<ol>
															...
															<li>3) 이용기간 : 원칙적으로 수집 및 이용목적이 달성된 후에 해당 정보를 지체없이
																파기합니다.</li>
															<li>4) 동의거부 권리 등 : 고객은 개인정보의 제공을 거부할 권리가 있습니다. 다만,
																개인정보 수집 및 이용동의에 동의하지 않거나 수집항목을 기재하지 않으시면 문의 접수 및 회신이 되지
																않습니다.</li>
														</ol>

														<p>(주)풀무원녹즙은 개인정보보호 관련 법률 및 각종 기준을 준수하고 있으며, 기타 자세한 사항은
															홈페이지에 공개한 "개인정보처리방침"을 참조하시기 바랍니다. 개인정보 수집 및 이용동의 안내 내용을 충분히
															이해하시고 이에 동의하여 주시기 바랍니다.</p>
														<!-- e: 20200309 약관 내용 수정 -->
														<!-- e: 20200310 약관 내용 수정 -->
														<!-- e: 20200313 약관 내용 수정 -->
													</div>
								...
								<ul class="business-faq-list" style="margin-top: 0px">
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">가맹점을 창업하고 싶은데 어떻게
												해야 하나요?</a>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">희망지역과 희망 사업(오피스, 홈) 여부를 작성하시어 상담
												신청을 해주시면 담당 부서에서 창업 가능 여부를 상담해 드립니다. 희망지역에 창업이 어려운 경우 영업관리자가
												거주지 중심으로 지역을 추천해드립니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">타인에게 사업 양도와 인수가
												가능한가요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">사업 양도는 가맹본부와 사전 협의 하에 가능합니다. 사업후보자를
												직접 모집하거나 가맹본부에서 모집을 지원하고 있으며, 양수도 거래는 가맹점사업자(가맹희망자)님들 간의 거래로
												이루어집니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">풀무원녹즙은 기존 운영지역의 배송 고객을 양도받아 사업을
												시작하는 경우가 대부분입니다. 가맹희망자가 희망하는 지역을 최우선으로 안내해드립니다. 신규 배송 희망 지역은
												영업 관리자가 사업성을 검토하여 상담해 드립니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">기존 음용 고객에 대한 영업권리금은 있으며, 별도 보증금은
												없습니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">동일 상권에서도 추가 개설이
												가능한가요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">풀무원녹즙은 가맹점간의 과열 경쟁을 지양하며 상생 협력을
												도모하고자 가맹사업법에 따른 영업지역을 설정하여 운영합니다. 가맹본부는 정당한 사유 없이 가맹계약기간 중
												가맹점사업자의 영업지역 안에 가맹점사업자와 동일한 업종의 직영점이나 가맹점을 설치하는 행위를 하지
												않습니다.(계열회사 포함) 다만, 설정된 영업지역 외는 추가 개설이 가능하며, 법령에 정한 사유에 해당하는 경우
												가맹점사업자와의 합의에 따라 추가 개설이 가능합니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">사무실 위치 선정 및 임대는 전적으로 가맹사업자가 직접
												진행합니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
									...
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">최초 가맹금은 사업 종료 시
												돌려받을 수 있나요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">최초 가맹금은 가맹점사업자가 가맹본부로부터 가맹본부의 영업표지
												사용과 경영 및 영업활동 등에 대한 지원, 교육 등을 제공 받는 대가로, 모든 프랜차이즈 사업체에서 계약 종료
												시 반환되지 않는 소멸성 경비로 지정하고 있습니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">최초가맹금은 어떻게 납부하는
												건가요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">가맹점사업자는 가맹계약 체결 후 D+2일 내 최초 가맹금을
												당사의 계좌(국민은행)로 입금해야 합니다. 가맹점사업자의 영업개시 또는 가맹계약 체결일부터 2개월이 지난
												예치가맹금은 가맹본부에 지급됩니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">사무실 운영 비품은 어떤 게
												필요한가요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">자율적으로 판단하여 가맹점 운영에 무리가 없도록 구입하여
												비치해주시는 것을 원칙으로 하되, 관련한 제 비용은 가맹점사업자가 부담합니다. 컴퓨터, 책상, 의자, 보드판,
												수납장, 캐비닛, 제품보관매대, 탕비실 제반, 문구류 등 가맹점 규모, 구좌, 인원 수에 따라 여건에 맞게
												구매하시면 됩니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">교육을 함께 시청할 수 있는 모니터(TV, 빔 프로젝터),
												냉장고, 냉동고, 에어컨 등이 필요하며 장비의 수량은 가맹점 규모, 구좌, 인원수 등 제반 여건 고려 후
												구매하시면 됩니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">영업시간은 평일 주 5일로 배송시간 외 고객관리, 스텝 관리
												시간이 소요됩니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">주요 고객층은 30~50대로 배송처는 관공서, 학교,
												금융권(은행, 증권사), 재래시장, 상가, 가정집 등으로 다양합니다. 일평균 약 20만명이 풀무원녹즙을 음용하고
												있습니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">배송스텝은 가맹본부에서
												모집해주나요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">운영직원과 배송스텝은 가맹점사업자가 직접 모집 하셔야 하며,
												가맹본부는 채용사이트를 통해 가맹점 사업자가 원만히 배송스텝을 모집할 수 있도록 온라인 홍보, 취업설명회 등을
												진행하여 지원하고 있습니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">배송스텝은 본사 특별 혜택이
												있나요? </a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">
												1. 월간 일정금액을 쌓아 목돈을 마련할 수 있는 적립금 제도를 운영하고 있습니다.<br> 2.
												상호부조와 혜택 향상을 도모하는 상조회 제도를 가맹점사업자들 간 운영하고 있습니다.<br> 3.
												자녀입학축하금, 국내외 연수, 로하스아카데미(연수원) 체험이 가능합니다. <br> 4. 배송스텝이
												정착할 수 있도록 정규과정 교육 프로그램이 무료 과정으로 상시 진행되고 있으며, 모닝스텝 전용 학습 플랫폼을
												제공합니다.
											</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">배송스텝도 창업을 시작할 수
												있나요? </a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">배송스텝(모닝스텝 or 홈스텝)으로 활동 하시다가 사업에
												자신감이 생겨 실제 가맹점사업자로 전환하는 경우가 많습니다. 자세한 사항은 상담을 통해 안내 받을 수 있습니다.
											</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">일반적인 프랜차이즈 사업에 비해 난이도가 낮고 가맹점사업자
												개인의 운영보다 배송스텝(모닝스텝, 홈스텝)을 모집하여 함께 운영하는 사업으로 여성 또는 가정주부도 충분히
												도전하실 수 있습니다. 현재, 전국 400여개 가맹점에서 약 230여개 가맹점(약 58%)은 여성 사장님이
												운영하고 계십니다.</div>
										</div>
									</li>
									<li class="faq-item js-fold-wrap">
										<div class="js-fold-header">
											<a href="javascript:;" class="faq-link" onclick="javascript:foldCont($(this));">가맹 계약 후 개설까지는 기간이
												얼마나 걸리나요?</a>
											<button type="button" class="btn-more-view">
												<i class="ico ico-fold-arrow"></i> <span class="offscreen">내용펼치기</span>
											</button>
										...
										<div class="faq-body js-fold-container">
											<div class="faq-cont">사업 후보자 검증 단계 이후 예비 가맹점사업자로 확정이 되면
												사업 개설시까지 약 20여 일이 소요됩니다.</div>
										</div>
									</li>
								</ul>
								<!--E:FAQ list-->
							...
							<div class="footer-btn-wrap js-footer-fixed is-fixed">
								<div class="section">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" class="btn-pos" onclick="javascript:$('.pop-qualification-area').dialog('open');">개설가능
										지역보기</button>
								</div>
							</div>
							<!--E: inquiry button-->
						...
						<div class="tab-cont js-tab-cont js-tab-cont-1" style="display: none;">
							...
							<div class="tab-cont js-btab-cont js-btab-cont-8">
								...
								<p class="stitle-desc">고객들에게 매일 아침 신선한 채소와 과일의 영양을 자연 그대로 담은
									풀무원녹즙 제품을 전달하여 건강을 관리하는 ‘건강지킴이’입니다.</p>
								<!-- 20200224 폰트 블랙컬러 삭제 -->
								...
								<div class="morning-staff-info">
									<ol class="morning-staff-list">
										<li><i class="ico ico-morning-staff-info03"></i>
											...
											<p class="desc">탄력적 시간 운영 가능! 전국 모닝스텝은 주5일 하루 5시간(배송업무
												4시간+기타업무 1시간) 전후 오전에 활동하고 선택적으로 추가적인 활동을 통해 소득을 올리고 있습니다. 가사와
												자녀 돌봄을 병행할 수 있어 시간적 제약이 크지 않고, 학력이나 나이제한은 없습니다.</p></li>
										<li><i class="ico ico-morning-staff-info02"></i>
											<p class="title">
												<em>02</em> 안정적 소득!
											</p>
											<p class="desc">모닝스텝은 녹즙 가맹점에 소속되어 지역과 고정 고객을 배정받아 활동하게 됩니다.
												활동초기 비용은 없으며,&nbsp;약&nbsp;5시간 활동으로 안정적인 수입을 올릴 수 있습니다.</p></li>
										<li><i class="ico ico-morning-staff-info01"></i>
											<p class="title">
												<em>03</em> 로하스 실천의 건강한 삶
											</p>
											<p class="desc">주말,&nbsp;공휴일을 제외하고 매일 아침 규칙적인 활동을 통해 다양한 고객을 만나며
												몸과 마음의 건강을 챙길 수 있습니다.</p></li>
									</ol>
								</div>
							...
							<div class="tab-cont js-btab-cont js-btab-cont-9" style="display: none;">
								...
								<ul class="morning-staff-benefit">
									<li><i class="ico ico-staff-benefit01"></i>
										...
										<p class="desc">
											월간 일정금액이 쌓이는 적립금 제도를 운영하고 있어요! 상호부조와 혜택 향상을 도모하는 상조회 제도가 있습니다.<br>상호부조와
											혜택 향상을 도모하는 상조회 제도를 가맹사업자들 간 운영하고 있습니다.자녀 입학 축하금,&nbsp;국내외
											연수,&nbsp;로하스아카데미 체험도 가능합니다!<br>(※&nbsp;가맹점별 운영기준이 상이할 수 있습니다.)
										</p></li>
									<li><i class="ico ico-staff-benefit02"></i>
										<p class="title">체계적 교육 제공!</p>
										<p class="desc">
											입문 교육&nbsp;&amp;&nbsp;정기 교육 프로그램을 진행합니다.<br>자세한 제품별 화법집과 리플렛을 드립니다.<br>모닝스텝
											전용 어플리케이션을 제공합니다.
										</p></li>
									<li><i class="ico ico-staff-benefit03"></i>
										...
										<div class="who-list">
											...
											<dl>
												<i class="ico ico-wholist"></i>
												<dt>
													"경력단절 10년만에 다시 당당하게 사회활동 하고 있어요. 고객님께 건강을 전하고,<br>제 건강도
													챙기고 일한만큼 수익까지! 앞으로 10년,20년 쭈욱 활동할 겁니다."
												</dt>
									...
									<li><i class="ico ico-staff-benefit04"></i>
										...
										<div class="qna-list">
											...
											<dl>
												...
												<dd>
													<i class="ico ico-qna-a"></i><em>지역과 기존 고객을 배정받고</em> 시작하게
													됩니다!
												</dd>
												<!-- 20200224 폰트 블랙컬러 삭제 -->
											</dl>
											<dl>
												...
												<dd>
													<i class="ico ico-qna-a"></i>탄력적인 근무시간으로 <em>일과 가정의 병행</em>이
													가능합니다!
												</dd>
												<!-- 20200224 폰트 블랙컬러 삭제 -->
											</dl>
								...
								<form id="listForm2">
									...
									<table class="tbl-row">
										...
										<tr>
											...
											<td class="input">
												<div class="ip-wrap">
													<input title="이름 입력" id="nameMorning" name="userName" type="text" placeholder="이름을 입력해주세요." maxlength="10">
										...
										<tr>
											...
											<td class="input">
												<div class="ip-wrap">
													<input title="입력" id="phoneMorning" name="cellPhone" data-call-text="" type="hidden" placeholder="‘-’없이 숫자만 입력해주세요" maxlength="13">
													<span class="message" id="phoneMorningError"></span>
												<input title="입력" name="_x_cellPhone" type="text" placeholder="‘-’없이 숫자만 입력해주세요" maxlength="13"></div>
											</td>
										</tr>
										<tr>
											<th scope="row">이메일</th>
											<td class="input">
												<div class="ip-wrap">
													<div class="ip-email-wrap">
														<input type="text" title="이메일 아이디 입력" id="emailMorning" name="emailMorning" placeholder="이메일" value="">
														<input type="hidden" title="이메일 아이디 입력" id="emailFullMorning" name="emailFullMorning" placeholder="이메일" value="@naver.com">
														<span class="gap">@</span>
														<input type="text" title="이메일 도메인 직접입력" id="emailHostMorning" name="emailHostMorning" value="">
														<select title="이메일 도메인 선택" id="emailHostListMorning" name="emailHostListMorning">
															<option value="">선택</option>
															<option value="naver.com" selected="selected">naver.com</option>
															<option value="daum.net">daum.net</option>
															<option value="hanmail.net">hanmail.net</option>
										...
										<tr>
											...
											<td class="input">
												<ul class="rc-list">
													<li>
														<div class="rc-item">
															<input name="hopeTime" id="ip-rdo2-1" type="radio" checked="" value="A"> <label for="ip-rdo2-1">오전
															배달</label>
														</div>
													</li>
													<li>
										...
										<tr>
											...
											<td class="input">
												<div class="ip-wrap">
													...
													<option value="" hidden="">년도</option><option value="1964">1964 년</option><option value="1965">1965 년</option><option value="1966">1966 년</option><option value="1967">1967 년</option><option value="1968">1968 년</option><option value="1969">1969 년</option><option value="1970">1970 년</option><option value="1971">1971 년</option><option value="1972">1972 년</option><option value="1973">1973 년</option><option value="1974">1974 년</option><option value="1975">1975 년</option><option value="1976">1976 년</option><option value="1977">1977 년</option><option value="1978">1978 년</option><option value="1979">1979 년</option><option value="1980">1980 년</option><option value="1981">1981 년</option><option value="1982">1982 년</option><option value="1983">1983 년</option><option value="1984">1984 년</option><option value="1985">1985 년</option><option value="1986">1986 년</option><option value="1987">1987 년</option><option value="1988">1988 년</option><option value="1989">1989 년</option><option value="1990">1990 년</option><option value="1991">1991 년</option><option value="1992">1992 년</option><option value="1993">1993 년</option><option value="1994">1994 년</option><option value="1995">1995 년</option><option value="1996">1996 년</option><option value="1997">1997 년</option><option value="1998">1998 년</option><option value="1999">1999 년</option><option value="2000">2000 년</option><option value="2001">2001 년</option><option value="2002">2002 년</option><option value="2003">2003 년</option></select> <span class="message" id="birthdayError"></span>
												</div>
											</td>
										</tr>
										<tr>
												...
												<div class="agree-container js-fold-container" style="display: none;">
													<div class="agree-cont">
														...
														<ol>
															...
															<li>3) 이용기간 : 원칙적으로 수집 및 이용목적이 달성된 후에 해당 정보를 지체없이
																파기합니다.</li>
															<li>4) 동의거부 권리 등 : 고객은 개인정보의 제공을 거부할 권리가 있습니다. 다만, 개인정보
																수집 및 이용동의에 동의하지 않거나 수집항목을 기재하지 않으시면 문의 접수 및 회신이 되지 않습니다.</li>
														</ol>
							...
							<div class="footer-btn-wrap js-footer-fixed is-fixed">
								<div class="section">
									...
									<button type="button" data-idx="10" data-href="js-btab-link" class="btn-pos js-btab-link" onclick="javascript:businessTabOpen(10);">풀무원녹즙 모닝스텝 지원
										바로가기</button>
								</div>
							</div>
							<!--E: morning-step-btn -->
