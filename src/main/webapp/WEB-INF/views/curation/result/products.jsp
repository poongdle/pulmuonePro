         ...
         <p>${list[0].program_name }</p>
          <c:forEach var="dto" items="${list}" begin="0" end="2">
            <div class="product-radio-group">
                <label data-item-index="${dto.curation_no }"  data-item-link="product/daily/278"  data-item-image="https://mgreenjuice.pulmuone.com/file/download/product/20210923/517eebaa-b721-4dba-b620-76689d2a25ab.jpg"
