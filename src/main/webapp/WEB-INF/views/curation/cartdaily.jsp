			...
			<div class="title-tab-area">
				...
				<ul class="nav nav-tabs nav-justified" id="myTab-area" role="tablist">
					<li class="nav-item" role="presentation">
						<a href="/cart/daily/cartdaily.do" class="nav-link active" style="padding-right: 4px; margin-bottom: 0px; height: 47px">
							매일배송
						</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="/cart/box/cartbox.do" class="nav-link " style="margin-bottom: 0px; height: 47px">
							택배배송
						</a>
					</li>
				</ul>
...
<li data-id="" data-itemcode="0072840" class="order-item order-chk" data-price="2000">
  
  <div class="checkbox chk-type3">
    <input type="checkbox" id="chk-prd-0072840" name="cartIdx" value="" checked="checked" data-itemcode="0072840">
  ...
  <button type="button" class="btn-delete btn-prd-delete" data-cart-idx="" data-itemcode="0072840">
						...
						<!--S:띠배너 슬라이드-->
							...
							<div class="banner-area this-prd" style="margin-bottom: 0px">
								<div class="banner-list">
									<a class="item" href="/event/event/view.do?event_no=2" title="장바구니_친구초대" style="background-color: #">
