        ...
        showNotAvailModal(o.fails, function () {
          ...
          get({url: '/order/daily/check/option'}, function (r) {
            if (typeof r.RESULT_MSG == 'object' && r.RESULT_MSG.length > 0) {
              ...
              location.href = "/order/daily/step1.do?item=" + encodeURIComponent(JSON.stringify(args2));
            }
          });
        });
      }
								...
								<ul class="nav nav-tabs nav-justified" id="myTab-area"
									...
									<li class="nav-item" role="presentation"><a
										...
										style="padding-right: 4px; margin-bottom: 0px; height: 47px">
											매일배송 </a></li>
									<li class="nav-item" role="presentation"><a
										href="/cart/box/cartbox.do" class="nav-link "
									...
									<div class="prd-cart-list-area" style="padding-top: 15px;">
										...
										<div data-empty-action="N">
											...
											<ul class="prd-cart-list  order-item-list">
												...
												<li data-id="" data-itemcode="0072840"
													class="order-item order-chk" data-price="2000">
														...
														<ul data-cart-idx="" data-itemcode="0072840">
															...
															<li><input type="hidden" data-count="0" value="1">
																...
																<div class="prd-select-daily">
																	...
																	<button type="button"
																		class="prod-remove ea-control btn-minus"
																		data-index="0">
															...
															<li><input type="hidden" data-count="1" value="0">
																<span>화</span>
																<div class="prd-select-daily">
																	<button type="button" class="prod-add ea-control"
																		data-index="1">
															...
															<li><input type="hidden" data-count="3" value="0">
																<span>목</span>
																<div class="prd-select-daily">
																	<button type="button" class="prod-add ea-control"
																		data-index="3">
										...
										<div class="banner-area this-prd" style="margin-bottom: 0px">
											<div class="banner-list">
												<a class="item" href="/event/event/view.do?event_no=2"
													title="장바구니_친구초대" style="background-color: #">
										...
										<dl>
											...
											<dd>
												<span>상품 판매가 (4주)</span> <b>
													<div class="now-price">
														<b data-price-view="origin">36,800</b> <span>원</span>
													</div>
												</b>
											</dd>
											<dd>
												...
												<span>상품 할인 판매가</span> <b>
													<div class="now-price">
														<b data-price-view="sale" class="">36,800</b> <span>원</span>
													</div>
												</b>
											</dd>
											...
											<dd class="checkout-sum">
												<span>4주예상 주문금액</span> <b>
													<div class="now-price">
														<b data-price-view="total">36,800</b> <span>원</span>
													</div>
												</b>
											</dd>
