...
//	   List<ProductsDTO> selectdaily(Connection con,String path, int num) throws SQLException;
	   List<ProductsDTO> select(Connection con,String path, int num) throws SQLException;
...
//	   List<ProductsDTO> selectboxbest(Connection con) throws SQLException;
	   // 3. 공용 상품 조회	   
	   List<ProductsDTO> search(Connection con,String path, String tags) throws SQLException;
	   
	   // 4. 공용 상품 카운트
//	   List<ProductsDTO> count(Connection con, String path) throws SQLException;
