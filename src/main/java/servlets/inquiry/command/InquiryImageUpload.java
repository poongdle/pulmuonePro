...
public class InquiryImageUpload implements CommandHandler{

	@Override
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		String saveDirectory = request.getRealPath("/upload/inquiry/");
		...
		File f = new File(saveDirectory);
	  	...
	  	String realPath = request.getServletContext().getRealPath("/upload/inquiry");
	  	...
	  	if( file != null ) {
	  		...
	  		outData.put("url", "/upload/inquiry/" + fileSystemName);
